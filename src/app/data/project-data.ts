...
export const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        description: {
            ...
            es: '"Este es un proyecto de portafolio desarrollado con Angular como parte del curso Maestro en JavaScript: Aprende JS, jQuery, Angular, NodeJS en Udemy. Este segmento representa el componente frontend del proyecto. <strong>Diseño Web Responsivo</strong> garantiza un rendimiento óptimo en todos los dispositivos.'
        },
    ...
    },
    {
        name: {
            ...
            es: 'Proyecto del Curso Maestro en JavaScript - Backend API CRUD'
        },
        ...
        description: {
            ...
            es: '"Este componente backend del Proyecto de Portafolio fue desarrollado durante el curso Maestro en JavaScript en Udemy. Incluye una API CRUD que permite al frontend crear, leer, actualizar y eliminar proyectos. Utilizando <strong>MongoDB</strong> como base de datos, esta API facilita una comunicación fluida entre el frontend y el backend. Las imágenes de los proyectos se suben a Imgbb mediante su API, guardando los enlaces en MongoDB, garantizando la recuperación dinámica de imágenes para cada proyecto.'
        },
